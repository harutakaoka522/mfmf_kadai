...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { route_name: @station.route_name, station_name: @station.station_name, walk_time: @station.walk_time } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { route_name: @station.route_name, station_name: @station.station_name, walk_time: @station.walk_time } }
